...
#ifdef CONFIG_TTU
#define MAPPHONE_HDTV_MUX_SEL_GPIO	7
#define MAPPHONE_HDTV_MUX_EN_GPIO	69
#endif
...
/* Retrieve the panel information */
	...
	mapphone_lcd_device.phy.dsi.clk_lane = 1;

	mapphone_lcd_device.phy.dsi.clk_pol = 0;

	mapphone_lcd_device.phy.dsi.data1_lane = 3;
	...
	mapphone_lcd_device.phy.dsi.data1_lane = 2;

	mapphone_lcd_device.phy.dsi.data1_pol = 0;

	mapphone_lcd_device.phy.dsi.data2_lane = 3;

	mapphone_lcd_device.phy.dsi.data2_pol = 0;

	mapphone_lcd_device.reset_gpio = 136;

	mapphone_lcd_device.panel.panel_id = 0x000a0001;
...
#ifdef CONFIG_TTU
	mapphone_tda19989_data.pwr_en_gpio = 41;
	mapphone_tda19989_data.int_gpio = 25;
#else
	/* return err if fail to open DT */
...
{
#if CONFIG_TTU
	mapphone_hdtv_mux_en_gpio = MAPPHONE_HDTV_MUX_EN_GPIO;
	mapphone_hdtv_mux_sel_gpio = MAPPHONE_HDTV_MUX_SEL_GPIO;
