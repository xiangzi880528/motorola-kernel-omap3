...
{
#ifdef CONFIG_TTU
	regulator_set_voltage(mapphone_vibrator_regulator, 1800000, 1800000);
#else
...
static void mapphone_lvibrator_init(void)
{
	vib_pwm_enable_gpio = MAPPHONE_GLOBAL_HAPTIC_GPIO; /* 9 */
	vib_pwm_period = 5714;
	vib_pwm_duty = 2857;
	return;
}
